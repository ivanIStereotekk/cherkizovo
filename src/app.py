...
Я Иван Гончаров, Python разработчик с опытом написания веб-сервисов и приложений для финансовой сферы,\n
внутренних инфраструктурных сервисов для частного бизнеса и предприятий. \n
Имею опыт работы в сфере автоматизации производственных процессов, работал инженером и администратором сетей. \n
Так как сфера очень интересна, постоянно интересуюсь технологиями. За время моей занятости в профессии я научился \n
получать своевременно качественную информацию, быть на чеку технологий и стараюсь осваивать все то что мне близко по духу.\n
Учу новое, не забываю старое, и делаю это буквально каждый день. Скажу откровенно, мне это нравится!\n
Уверен если вы примите решение в пользу меня, вы получите не только хорошего специалиста но и человека\n
увлеченного своим делом. \n Отзывчивого и позитивного коллегу, готового поддержать в сложной ситуации.\n
Кроме бекенд разработки я интересуюсь и экспериментирую с другими технологиями. Мне нравится компьютерное зрение, \n
мобильная разработка, фронтенд, эксперименты с звуком и пообещал себе освоить ML. \n
Есть навык разработки фронтенд приложений, [ React / Next.js / Tailwind ] И как мне кажется это еще одно перспективное направление\n
куда я намерен двигаться и расти.\n
Так или иначе я часто для общего развития тестирую и пробую интересные мне технологии, фреймворки, библиотеки, ЯП. \n
В этом я чувствую свободу которая меня вдохновляет!
___________
